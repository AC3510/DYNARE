...
%values 3.7500 , 4.2500 , 4.5000 , 4.7500 , 4.7500 , 4.7500 ,  4.5000 , 4.5000 ; %Hawkish
...
var Dpae;
periods 1,2,3,4,5,6,7,8; 
values 2.8713  , -0.0541 ,   0.9044  ,  3.1621  ,  1.3340 ,  -0.3806 ,   0.2726 ,   1.6087;

var x;
periods 1,2,3,4,5,6,7,8; 
values  0.8392  ,  0.8392  ,  0.8392 ,   0.8392 ,   0.8392  ,  0.8392 ,   0.8392, 0.8392;

var DTI;
periods 1,2,3,4,5,6,7,8; 
values -18.6253  , -5.6622 ,  -1.1834 ,  -1.1180 ,  -3.8131,   -3.4606 ,  -3.5494 , -2.9908;

var tau;
periods 1,2,3,4,5,6,7,8; 
values -0.3079 ,  -1.3943  , -1.4415 ,  -1.2054 ,  -1.2236 ,  -1.2662 ,  -1.3187, -1.3048;

var Dpms;
periods 1,2,3,4,5,6,7,8; 
values 8.9483 ,  -1.8113 ,  -6.0031 ,  -6.0205 ,  -3.6098 ,  -4.7881 ,  -4.1458, -4.1243;
...
var Dps;
periods 1,2,3,4,5,6,7,8; 
values  4.6490  , -4.3273  ,  5.7511 ,   7.4799  ,  7.3425  , -7.6871   , 2.5081  ,  4.6944;

var is;
periods 1,2,3,4,5,6,7,8; 
values  0.9498  ,  1.3665 ,   1.6998 ,   1.9498  ,  2.1998  ,  2.4498 ,   2.6165  ,  2.6998;
...
var ys;
periods 1,2,3,4,5,6,7,8; 
values  -0.0609 ,   0.0325 ,   0.1251 ,   0.2619 ,   0.0227  , -0.3209 ,  -0.6918  ,  -1.0770;
...
conditional_forecast(parameter_set = calibration, controlled_varexo = ( res_Dpae, res_x, res_DTI, res_tau, res_Dpms, res_g, res_t, res_EDy, res_ED4s, res_Dps, res_is, res_ins, res_ys, res_DYs_eq, res_z, res_DY_eq, res_in, res_zmn, res_zme, res_x_eq, res_DQ_eq), replic = 5000, conf_sig = 0.99);
%plot_conditional_forecast(periods=4) y D4psae D4p;
